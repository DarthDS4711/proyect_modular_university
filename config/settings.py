...
DATABASES = DATABASES_APPLICATION
...
# direcciones de los archivos estaticos
STATIC_URL = '/static/'
...
# modelo de usuario personalizado a usar como default
...
# serializar en la sesión, instancias de los modelos
