function return_array_color(){
    ...
    let array_color = []
    for(let index = 0; index < array_general.length; index++){
        array_color.push(array_general[index]['rgb']);
        //array_color.push(array_color[index].rgb);
        //console.log(array_color[index]);
    }
    return array_color;  
}